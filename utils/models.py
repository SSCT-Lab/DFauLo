...
class LSTM(nn.Module):
    def __init__(self, voc_len=95805, PAD=0):
...
class LSTM_NCNV(nn.Module):
    def __init__(self, voc_len=95805, PAD=0):
        super(LSTM_NCNV, self).__init__()
        self.embedding = nn.Embedding(num_embeddings=voc_len, embedding_dim=200, padding_idx=PAD)
        self.lstm = nn.LSTM(input_size=200, hidden_size=128, num_layers=2, batch_first=True, dropout=0.5)
...
class BiLSTM(nn.Module):
    def __init__(self, voc_len=95805, PAD=0):
        ...
        self.embedding = nn.Embedding(num_embeddings=voc_len, embedding_dim=200, padding_idx=PAD)
        self.lstm = nn.LSTM(input_size=200, hidden_size=128, num_layers=2, bidirectional=True, batch_first=True,
                            dropout=0.5)
...
class BiLSTM_NCNV(nn.Module):
    def __init__(self, voc_len=95805, PAD=0):
        super(BiLSTM_NCNV, self).__init__()
        self.embedding = nn.Embedding(num_embeddings=voc_len, embedding_dim=200, padding_idx=PAD)
        self.lstm = nn.LSTM(input_size=200, hidden_size=128, num_layers=2, bidirectional=True, batch_first=True,
                            dropout=0.5)
        self.fc1 = nn.Linear(128 * 2, 128)
...
def ResNet():
    return ResNet_(ResidualBlock)


class ResNet_NCNV_(nn.Module):
    def __init__(self, ResidualBlock, num_classes=10):
        super(ResNet_NCNV_, self).__init__()
        self.inchannel = 16
        self.conv1 = nn.Sequential(
            nn.Conv2d(3, 16, kernel_size=3, stride=1, padding=1, bias=False),
            nn.BatchNorm2d(16),
...
def ResNet_NCNV():
    return ResNet_NCNV_(ResidualBlock)
